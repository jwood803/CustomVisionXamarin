...
using System.IO;
using System.Linq;
using HerbsCustomVision.Helpers;
...
namespace HerbsCustomVision
{
    public class HerbVisionService
    {
        ...
        public HerbVisionService()
        {
            _trainingApi = new TrainingApi() { ApiKey = Secrets.TrainingKey };
            _predictionEndpoint = new PredictionEndpoint() { ApiKey = Secrets.PredictionKey };
